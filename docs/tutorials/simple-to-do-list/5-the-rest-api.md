...
To do so, you are going to use a _controller_. Controllers receive the HTTP requests and process them. They may call _services_ in the background to help them do this. We will not study the services in this tutorial.
