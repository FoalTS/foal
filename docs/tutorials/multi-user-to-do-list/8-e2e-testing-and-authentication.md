...
The last part of this tutorial explains how to write and run _end-to-end_ tests. The purpose of these tests is not to verify that each feature of each component works, but to check that these components work properly together.
...
![E2E tests output](../../.gitbook/assets/e2e_output.png)
