...
*Defined in [common/errors/object-does-not-exist.ts:30](https://github.com/FoalTS/foal/blob/70cc46bd/packages/core/src/common/errors/object-does-not-exist.ts#L30)*
