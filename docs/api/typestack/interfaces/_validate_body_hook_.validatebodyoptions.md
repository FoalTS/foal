[@foal/typestack](../README.md) > ["validate-body.hook"](../modules/_validate_body_hook_.md) > [ValidateBodyOptions](../interfaces/_validate_body_hook_.validatebodyoptions.md)
