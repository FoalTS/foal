...
*Defined in [entities/user-with-permissions.entity.ts:25](https://github.com/FoalTS/foal/blob/aac11366/packages/typeorm/src/entities/user-with-permissions.entity.ts#L25)*
...
*Defined in [entities/user-with-permissions.entity.ts:21](https://github.com/FoalTS/foal/blob/aac11366/packages/typeorm/src/entities/user-with-permissions.entity.ts#L21)*
...
*Defined in [entities/user-with-permissions.entity.ts:29](https://github.com/FoalTS/foal/blob/aac11366/packages/typeorm/src/entities/user-with-permissions.entity.ts#L29)*
...
*Defined in [entities/user-with-permissions.entity.ts:39](https://github.com/FoalTS/foal/blob/aac11366/packages/typeorm/src/entities/user-with-permissions.entity.ts#L39)*
