...
* [The Authentication System](./the-authentication-system/SUMMARY.md)
  * [User Entity & create-user Script](./the-authentication-system/user-entity.md)
  * [Permissions & Authorization](./the-authentication-system/permissions-and-authorization.md)
  * [Usage in Web Requests](./the-authentication-system/usage-in-web-requests.md)
