...
describe('upgrade', () => {
  ...
  context('given a version is provided', () => {
    it('should upgrade all @foal/* dependencies and NOT the other dependencies.', async () => {
      fs
    ...
    it('should upgrade all @foal/* dev dependencies and NOT the other dev dependencies.', async () => {
      fs
        .copyFixture('upgrade/package.json', 'package.json')
