...
export abstract class EntityResourceCollection implements IResourceCollection {
  ...
  async create(user: any, data: object, params: { fields?: string[] }): Promise<object> {
  ...
  async findById(user: any, id, params: { fields?: string[] }): Promise<object> {
  ...
  async find(user: any, params: { query?: object, fields?: string[] }): Promise<object[]> {
  ...
  async deleteById(user: any, id, params: {}): Promise<void> {
